...
void sendArduinConnect(){
  ...
  arduinoData.clockYear = tmYearToCalendar(clockTime.Year);
  arduinoData.clockMonth = clockTime.Month;
  arduinoData.clockDay = clockTime.Day;
  arduinoData.clockHour = clockTime.Hour;
  arduinoData.clockMinute = clockTime.Minute;
  arduinoData.clockSeconds = clockTime.Second;
